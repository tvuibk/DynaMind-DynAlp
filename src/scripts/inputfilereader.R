...
for(file in 1:length(list)) 
{
  ...
  # suche für jedes Subcatchment den Gitterpunkt mit dem geringsten Abstand und speichere Subcatchment mit jeweiligem GP in minima
  ...
  ##### schreibe Tabelle mit neuen 'Rain Gage' so wie bisher in der Inputfile für [Subcatchment]
  ...
  # bilde 1 Spalte aus Raingages-Daten mit Spaltenbreite wie die Bindestriche unter deren Überschriften
  ...
  # bilde 1 Spalte aus Subcatchments-Daten mit Spaltenbreite wie die Bindestriche unter deren Überschriften
